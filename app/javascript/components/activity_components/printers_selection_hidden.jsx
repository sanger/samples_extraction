  ...
  render() {
    return(
    	<HashFields name={this.props.entityName}>
   			<HiddenFieldTag name={this.nameForField("tube_printer_id")} value={this.props.selectedTubePrinter} className='tube_printer' />
   			<HiddenFieldTag name={this.nameForField("plate_printer_id")} value={this.props.selectedPlatePrinter} className='plate_printer' />
  		</HashFields>
  	)
  }
}
