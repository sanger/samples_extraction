...
ActiveRecord::Schema.define(version: 2018_07_03_154511) do
  ...
  create_table "uploaded_files", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.integer "asset_id"
